...
$(function () {
  "use strict"; // windowHeight-middle
...
$(document).ready(function () {
  ...
  $(".fixed-menu-options-padding-body .fa-bars").on("click", function () {
    $(this).parent(".fixed-menu-options-padding-body").toggleClass("is-visible");

    if ($(this).parent(".fixed-menu-options-padding-body").hasClass("is-visible")) {
