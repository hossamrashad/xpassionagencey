...
$(function () {
  ...
  $("body, .paddingNavbarHeight").css("paddingTop", $(".navbar").innerHeight()); // console.log($(".navbar").innerHeight());
}); // typed js
...
$(function () {
  ...
  var typed = new Typed(".jq-typed-page-about", {
    ...
    strings: ["اكس باشون شركة تصنع قصص نجاح للشركات الصغيرة والكبيرة .", " تقدم تكنولوجيا معلومات ذات مستوى عالمي . ", "وكالة رقمية للاستشارات التسويقية وتصميم المواقع الكترونية"],
    typeSpeed: 100,
    startDelay: 500,
    backDelay: 1000,
    loop: true,
